  ...
  return (
    <div className="flex items-center justify-between px-4 py-3 bg-gray-100/80 border-b border-gray-200">
      ...
      <div className="flex items-center gap-1">
        ...
        >
          <svg className={`w-5 h-5 ${cfHandle ? "" : "grayscale opacity-40"}`} viewBox="0 0 24 24" fill="currentColor">
        ...
        >
          <svg className={`w-5 h-5 ${ghRepoPath ? "text-black" : "text-gray-300"}`} viewBox="0 0 24 24" fill="currentColor">
