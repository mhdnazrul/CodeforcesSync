...
- [ ] **Chrome Web Store submission** — Package the extension for the Chrome Web Store to enable one-click installation and automatic updates.
...
- [ ] **Cross-browser support (Firefox)** — Port the extension to Firefox using Manifest V3 or V2. The browser abstraction layer (`src/browser/`) was designed with this in mind.
